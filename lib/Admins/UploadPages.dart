...
import 'package:e_shop/Categories/Kurti.dart';
import 'package:e_shop/Categories/Stiched.dart';
import 'package:e_shop/Categories/UnStiched.dart';
import 'package:e_shop/Categories/bridal.dart';
import 'package:e_shop/Categories/productDiscountUpload.dart';
import 'package:e_shop/Categories/productPopularUpload.dart';
import 'package:e_shop/Categories/saris.dart';
...
class _UploadPageState extends State<UploadPages> with AutomaticKeepAliveClientMixin<UploadPages>
{
      ...
      child: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Icon(Icons.shop_two,color: Colors.white,size: 20.0,),

              Padding(
                padding: EdgeInsets.only(top: 5.0),
                child: RaisedButton(
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(2.0)),
                  child: Text("UploadHomeDiscountCategories",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                  color: Colors.green,
              ...
              Padding(
                ...
                child: RaisedButton(
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(2.0)),
                  child: Text("Upload Rental ",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                  color: Colors.green,
                  onPressed: () {
              ...
              Padding(
                ...
                child: RaisedButton(
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(2.0)),
                  child: Text("UploadHomePopularItems",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                  color: Colors.green,
                  onPressed: () {
              ...
              Padding(
                ...
                child: RaisedButton(
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(2.0)),
                  child: Text("UploadPopularItems",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                  color: Colors.green,
                  onPressed: () {
              ...
              Padding(
                ...
                child: RaisedButton(
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(2.0)),
                  child: Text("UploadDiscountItems",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                  color: Colors.green,
                  onPressed: () {
              ...
              Padding(
                ...
                child: RaisedButton(
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(2.0)),
                  child: Text("UploadKurtiCategories",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                  color: Colors.green,
                  onPressed: () {
              ...
              Padding(
                ...
                child: RaisedButton(
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(2.0)),
                  child: Text("UploadBridalCategories",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                  color: Colors.green,
                  onPressed: () {
              ...
              Padding(
                ...
                child: RaisedButton(
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(2.0)),
                  child: Text("UploadSarisCategories",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                  color: Colors.green,
                  onPressed: () {
  ...
  takeImage(mContext){
    return showDialog(
        ...
        builder: (con){
          return SimpleDialog(
            title: Text("ItemImage",style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold),),
            children: [
              SimpleDialogOption(
