...
class _UploadPageState extends State<Bridal> with AutomaticKeepAliveClientMixin<Bridal>
{
          ...
          children: [
            ...
            Padding(
                ...
                child: RaisedButton(
                    ...
                    child: Text("bridal",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                    color: Colors.green,
                    onPressed: ()
                    => takeImage(context))
            ),
...
_brandTextEditingController.clear();
  ...
  saveItemInfo( String downloadUrl){
    final itemsRef = Firestore.instance.collection("category").document("kkjjkdjskjk4zzzz524lklk").collection("bridal");
