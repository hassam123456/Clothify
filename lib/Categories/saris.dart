...
class Saris extends StatefulWidget
{
  @override
  _UploadPageState createState() => _UploadPageState();
}

class _UploadPageState extends State<Saris> with AutomaticKeepAliveClientMixin<Saris>
{
          ...
          children: [
            ...
            Padding(
                ...
                child: RaisedButton(
                    ...
                    child: Text("Saris",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                    color: Colors.green,
                    onPressed: ()
                    => takeImage(context))
            ),
  ...
  saveItemInfo( String downloadUrl){
    final itemsRef = Firestore.instance.collection("category").document("kkjjkdjskjk4zzzz524lklk").collection("saris");
