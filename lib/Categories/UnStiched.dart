...
class UnStiched extends StatefulWidget
{
  @override
  _UploadPageState createState() => _UploadPageState();
}

class _UploadPageState extends State<UnStiched> with AutomaticKeepAliveClientMixin<UnStiched>
{
          ...
          children: [
            ...
            Padding(
                ...
                child: RaisedButton(
                    ...
                    child: Text("UnStiched",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                    color: Colors.green,
                    onPressed: ()
                    => takeImage(context))
            ),
  ...
  saveItemInfo( String downloadUrl){
    final itemsRef = Firestore.instance.collection("category").document("kkjjkdjskjk4zzzz524lklk").collection("Unstiched");
