...
class _UploadPageState extends State<discountProduct> with AutomaticKeepAliveClientMixin<discountProduct>
{
  ...
  saveItemInfo( String downloadUrl){
    final itemsRef = Firestore.instance.collection("product").document("kkjjkdjskjk4zzzz524lklk").collection("discountProduct");
