...
class _UploadPageState extends State<popularProduct> with AutomaticKeepAliveClientMixin<popularProduct>
{
          ...
          children: [
            ...
            Padding(
                ...
                child: RaisedButton(
                    ...
                    child: Text("PopularProduct",style: TextStyle(color: Colors.white,fontSize: 20.0),),
                    color: Colors.green,
                    onPressed: ()
                    => takeImage(context))
            ),
  ...
  saveItemInfo( String downloadUrl){
    final itemsRef = Firestore.instance.collection("product").document("kkjjkdjskjk4zzzz524lklk").collection("popularProduct");
